...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('assets/img/ts.png') }}" rel="icon">
...
<body>
    ...
    <!-- ======= Header ======= -->
    <header id="header" class="header d-flex align-items-center bg-danger border-bottom border-5 border-warning">

        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <!-- Uncomment the line below if you also wish to use an image logo -->
                <img src="{{ asset('assets/img/ts.png') }}" alt="">
                <h1 class="  d-sm-none">Tapak Suci 177 Gowa</h1>
            </a>
    ...
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="hero bg-danger">
                ...
                <div id="carouselExampleDark" class="carousel carousel-dark slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="3000">
                            <img src="{{ asset('tema-landing-page/assets/img/gw1.jpeg') }}" class="d-block w-100"
                                alt="...">
                        ...
                        <div class="carousel-item" data-bs-interval="3000">
                            <img src="{{ asset('tema-landing-page/assets/img/gw2.jpeg') }}" class="d-block w-100"
                                alt="...">
                            <div class="carousel-caption d-none d-md-block">
    ...
    <main id="main">
        ...
        <section class="">
            <div class="container" data-aos="fade-up">
                <div class="row">
                    <a href="{{ url('rewako-cup') }}" class="btn btn-lg btn-danger d-block" class="col-12">
                        <img src="{{ asset('storage/img-web/rewako.png') }}" alt="" srcset=""
                            width="400px">
                    </a>
                </div>
            </div>
        ...
        <section class="px-3 d-flex ">
            <div class="container" data-aos="fade-up">
                <div class="row">
                    <iframe width="100%" height="401" src="https://www.youtube.com/embed/gbk4mgzS2x0"
                        title="Merawat Tradisi, Kalau Bukan kita, siapa lagi?" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        allowfullscreen class="col-lg-6 col-sm-12 shadow"></iframe>

                    <div class="col-lg-6 col-sm-12 mt-sm-3">
                        <h3>Merawat Tradisi, Kalau Bukan Kita, Siapa Lagi?</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic tempora officiis repudiandae
                            labore
                            laborum itaque ullam dolores. Quos eos, ad dignissimos doloremque veniam corrupti porro
                            iusto facere
                            dolorum sequi illum.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="testimonials" class="testimonials">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h2>Testimonials</h2>
                    <p>Apa kata mereka tentang Tapak Suci 177 Gowa</p>
                </div>
            ...
            <div class="row gy-4">
                <div class="col-lg-5 col-md-12 footer-info">
                    <a href="" class="logo d-flex align-items-center">
                        <span>TAPAK SUCI 177 GOWA</span>
                    </a>
                    <p>Prestasimu Dakwahmu, Dakwahmu Prestasimu </p>
